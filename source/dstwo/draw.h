...
#define ICON_ZIPFILE      gui_icons[3]
#define ICON_DIRECTORY    gui_icons[4]
#define ICON_GBAFILE      gui_icons[5]
#define ICON_TITLE        gui_icons[6]

#define ICON_AVO          gui_icons[7]
#define ICON_SAVO         gui_icons[8]
#define ICON_TOOL         gui_icons[9]
#define ICON_CHEAT        gui_icons[10]
#define ICON_OTHER        gui_icons[11]
#define ICON_EXIT         gui_icons[12]
#define ICON_MSEL         gui_icons[13]
#define ICON_MNSEL        gui_icons[14]
#define ICON_NAVO         gui_icons[15]
#define ICON_NSAVO        gui_icons[16]
#define ICON_NTOOL        gui_icons[17]
#define ICON_NCHEAT       gui_icons[18]
#define ICON_NOTHER       gui_icons[19]
#define ICON_NEXIT        gui_icons[20]

#define ICON_UNKNOW       gui_icons[21]
#define ICON_MAINITEM     gui_icons[22]
#define ICON_NMAINITEM    gui_icons[23]
#define ICON_MAINBG       gui_icons[0]

#define ICON_TITLEICON    gui_icons[24]
#define ICON_SUBBG        gui_icons[1]

#define ICON_SUBSELA      gui_icons[2]
