...
{
	// Before a menu gets implemented, START+SELECT held together are equivalent to an
	// exit command.
	if ((LastButtons & (GCW_ZERO_BUTTON_START | GCW_ZERO_BUTTON_SELECT)) == (GCW_ZERO_BUTTON_START | GCW_ZERO_BUTTON_SELECT))
		quit();
	else if ((LastButtons & (GCW_ZERO_BUTTON_X | GCW_ZERO_BUTTON_SELECT)) == (GCW_ZERO_BUTTON_X | GCW_ZERO_BUTTON_SELECT))
		ApplyScaleMode(fullscreen);
	else if ((LastButtons & (GCW_ZERO_BUTTON_Y | GCW_ZERO_BUTTON_SELECT)) == (GCW_ZERO_BUTTON_Y | GCW_ZERO_BUTTON_SELECT))
