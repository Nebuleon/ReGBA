...
#define collapse_flags()                                                      \
  reg[REG_CPSR] = (n_flag << 31) | (z_flag << 30) | (c_flag << 29) |          \
   (v_flag << 28) | (reg[REG_CPSR] & ~0xF0000000)                             \
...
#define thumb_subc(type, dest_reg, src_a, src_b, carry)                       \
{                                                                             \
  thumb_decode_##type();                                                      \
  const u32 _sa = src_a;                                                      \
  const u32 _sb = src_b;                                                      \
  u32 dest = _sa - _sb - (c_flag ^ 1);                                        \
  calculate_flags_sub(dest, src_a, src_b);                                    \
  reg[dest_reg] = dest;                                                       \
  thumb_pc_offset(2);                                                         \
}                                                                             \
  ...
  {                                                                           \
    ...
    case 0x41:                                                                \
      ...
      {                                                                       \
        ...
        case 0x02:                                                            \
          /* SBC rd, rs */                                                    \
          thumb_subc(alu_op, rd, reg[rd], reg[rs], c_flag);                   \
          break;                                                              \
                                                                              \
        case 0x03:                                                            \
          /* ROR rd, rs */                                                    \
    ...
    case 0xD8:                                                                \
      /* BHI label */                                                         \
      thumb_conditional_branch((c_flag & (z_flag == 0)));                     \
      break;                                                                  \
                                                                              \
    case 0xD9:                                                                \
      /* BLS label */                                                         \
