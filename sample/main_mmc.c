...
----------------------------------------------------------------------
File        : main.c
Purpose     : Sample program for using the file system on MMC/SD
----------------------------------------------------------------------
...
#if FS_POSIX_DIR_SUPPORT
  /* show root directory of mmc device */
  _show_directory("mmc:");

  /* show sub directory of mmc device */
  _show_directory("mmc:\\jdi");

  /* show sub directory of mmc device */
  _show_directory("mmc:\\spec");

#endif /* FS_POSIX_DIR_SUPPORT */

  /* dump file on you mmc device */
  _dump_file("mmc:\\qtopia.txt");

  /* display disk space information of the mmc device */
  _show_free("mmc:");
